      ...
      <form action={action} className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            required
            maxLength={80}
            placeholder="Claude app"
            className="h-11"
          />
          <p className="text-xs text-muted-foreground">
            Etiqueta para identificar dónde se usa. Los artifacts creados con este
            token se atribuyen a ti.
          </p>
        </div>
      ...
      {state?.ok && (
        <div className="border border-success bg-success/5 p-4 space-y-3">
          <div className="meta text-success">
            TOKEN CREADO · «{state.name}»
          </div>
          <p className="text-sm text-muted-foreground">
            Cópialo ahora. Por seguridad no volverá a mostrarse — solo guardamos
            un hash.
          </p>
